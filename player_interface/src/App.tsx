...
function App() {
  const [activeTab, setActiveTab] = useState<
    "character" | "inventory" | "dice" | "map" | "categories"
  >("character");
  ...
  const inventory: InventoryItem[] = [
    ...
    },
    {
      ...
      name: "Lockpicks",
      type: "misc",
      description: "Masterwork thieves' tools",
      quantity: 5,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-dungeon text-stone-100 font-sans">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <div className="font-bold text-amber-300 glow-text">
                  Thorin Ironforge
                </div>
              </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="stone-panel p-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-xl font-bold text-amber-300 glow-text font-medieval">
                  Thorin Ironforge
                </h2>
            ...
            {/* Attributes */}
            <div className="stone-panel p-6">
              <h3 className="text-lg font-bold text-amber-300 glow-text mb-4 font-medieval">
                ATTRIBUTES
              </h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="stat-item">
                  ...
                  <div className="text-xl font-bold text-red-300 glow-stat">
                    {character.strength}
                  </div>
                </div>
                <div className="stat-item">
                  ...
                  <div className="text-xl font-bold text-green-300 glow-stat">
                    {character.dexterity}
                  </div>
                </div>
                <div className="stat-item">
                  ...
                  <div className="text-xl font-bold text-blue-300 glow-stat">
                ...
                <div className="stat-item">
                  ...
                  <div className="text-xl font-bold text-purple-300 glow-stat">
                    {character.wisdom}
                  </div>
                </div>
                <div className="stat-item">
                  ...
                  <div className="text-xl font-bold text-yellow-300 glow-stat">
                ...
                <div className="stat-item">
                  ...
                  <div className="text-xl font-bold text-orange-300 glow-stat">
                    {character.charisma}
                  </div>
                </div>
              </div>
            ...
            <div className="stone-panel p-6">
              ...
              <div className="space-y-3">
                {inventory.map((item) => (
                  <div
                    key={item.id}
                    className="inventory-item p-4 bg-stone-800/30 rounded border border-stone-700 hover:border-amber-600 transition-colors"
                  >
        ...
        {activeTab === "dice" && (
          <div className="max-w-2xl mx-auto">
            <div className="stone-panel p-8 text-center">
              <h3 className="text-2xl font-bold text-amber-300 glow-text mb-6 font-medieval">
                DICE ROLLER
              </h3>
              ...
              <div className="mb-8">
                ...
                {diceResult && !isRolling && (
                  <p className="text-amber-300 glow-text font-bold">
        ...
        {activeTab === "map" && (
          <div className="stone-panel p-6">
            <h3 className="text-2xl font-bold text-amber-300 glow-text mb-6 font-medieval text-center">
              CURRENT QUEST
            </h3>
            <div className="max-w-2xl mx-auto">
              <div className="quest-card p-6 bg-stone-800/50 rounded border border-amber-600/30 mb-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-xl font-bold text-amber-300 glow-text mb-2">
                      The Lost Crown of Athros
                    </h4>
                    <p className="text-stone-300 leading-relaxed mb-4">
                      Deep within the Whispering Caverns, an ancient crown lies
                      hidden. Legend speaks of its power to command the very
                      stones themselves. But beware - the caverns are filled
                      with dangers both old and new.
                    </p>
