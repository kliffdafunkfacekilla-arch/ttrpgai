...
@app.post("/v1/characters/", response_model=schemas.CharacterContextResponse, status_code=201)
...
@app.put("/v1/characters/{char_id}/apply_damage", response_model=schemas.CharacterContextResponse, tags=["Combat Integration"])
...
@app.put("/v1/characters/{char_id}/apply_status", response_model=schemas.CharacterContextResponse, tags=["Combat Integration"])
...
@app.put("/v1/characters/{char_id}/location", response_model=schemas.CharacterContextResponse, tags=["Location"])
